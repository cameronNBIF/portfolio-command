...
| Path | Contents |
|---|---|
| `docs/architecture-decisions.md` | 39 ADRs plus the decision log. **The authority for any "why is it like this" question.** ADR-033, ADR-034 and ADR-035 are **Accepted** (landed with F1, F2 and F3, 20 Aug 2026); ADR-036 to ADR-039 are **Proposed** — raised at F0 ahead of the code, accepted as each phase lands. |
