...
| Path | Contents |
|---|---|
| `docs/architecture-decisions.md` | 39 ADRs plus the decision log. **The authority for any "why is it like this" question.** ADR-033 and ADR-034 are **Accepted** (landed with F1 and F2, 20 Aug 2026); ADR-035 to ADR-039 are **Proposed** — raised at F0 ahead of the code, accepted as each phase lands. |
