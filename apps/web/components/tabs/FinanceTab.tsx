...
//
// Commitment, drawdown, distribution. Two of the three were always here and
// the middle one is a transaction, so this surface holds the stage that was
// missing (commitments) and the GP statements that value it, and points at the
// Transactions surface for the movements themselves.
//
// COMMITMENTS COME FIRST because they come first: a drawdown is a draw against
// a commitment already made, and the ledger reads top-down in the order the
      ...
      <div className="fbar">
        <button
          ...
          onClick={() => {
            ...
            setEditing({
              id: null,
              draft: { ...EMPTY_COMMITMENT, ...(fundInvestmentId ? { fundInvestmentId } : {}) },
              reason: '',
            });
          }}
        >
          ...
          <FormGrid>
            ...
            >
              <input
                ...
                onChange={(e) => setEditing({ ...editing, draft: { ...editing.draft, committed: e.target.value } })}
              />
            </Field>
            <Field
            ...
            >
              <input
                type="text"
                value={editing.draft['changeReason'] ?? ''}
                onChange={(e) =>
                  setEditing({ ...editing, draft: { ...editing.draft, changeReason: e.target.value } })}
              />
            </Field>
            <Field label="Source document">
              <input
      ...
      <div className="fbar">
        <button
          ...
          onClick={() => {
            ...
            setEditing({
              id: null,
              draft: { ...EMPTY_NAV, ...(fundInvestmentId ? { fundInvestmentId } : {}) },
              reason: '',
            });
          }}
        >
